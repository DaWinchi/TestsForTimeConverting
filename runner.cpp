...
CxxTest::StaticSuiteDescription suiteDescription_Tests( "Tests.h", 4, "Tests", suite_Tests, Tests_Tests );

static class TestDescription_suite_Tests_test1 : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_Tests_test1() : CxxTest::RealTestDescription( Tests_Tests, suiteDescription_Tests, 9, "test1" ) {}
